        ...
        <form id="acceptCheckoutForm" novalidate autocomplete="on">
          ...
          <div class="co-section">
            ...
            <label class="co-agree">
              ...
              <span>I have read and agree to the <a href="#" target="_blank">Terms of Service</a> and authorize Victorious Opportunities to charge my card for the selected plan. <strong>I understand the recurring monthly charge (if any) will begin 30 days after today.</strong></span>
            </label>

            <label class="co-agree">
              <input type="checkbox" name="agree_privacy" value="1" required />
              <span>I have read the <a href="#" target="_blank">Privacy Policy</a> and consent to my data being used to deliver this service.</span>
            </label>
