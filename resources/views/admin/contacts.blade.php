        ...
        <tr>
          ...
          <td class="actions">
            @unless ($rm)
              ...
              <form class="adm-inline-form" method="POST" action="{{ route('admin.contacts.destroy', $c) }}" onsubmit="return confirm('Delete this contact submission? This cannot be undone.');">
                @csrf @method('DELETE')
