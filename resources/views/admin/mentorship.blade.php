        ...
        <tr>
          ...
          <td class="actions">
            @unless ($rm)
              ...
              <form class="adm-inline-form" method="POST" action="{{ route('admin.mentorship.destroy', $m) }}" onsubmit="return confirm('Delete this mentorship lead? This cannot be undone.');">
                @csrf @method('DELETE')
